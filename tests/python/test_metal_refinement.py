...
from drumfoundry.refinement.metal_search import (
    shared_edit,
    texture_cases,
    damping_cases,
    fit_upper_balance,
...
from drumfoundry.refinement.metal_balance import CrashBalance
from drumfoundry.refinement.ridge_contrast import ridge_contrast
from drumfoundry.refinement.contracts import training_seeds, audit_seeds, prepare_output


def parameters():
    fit = json.loads((ROOT / "presets/factory/crash.fit.json").read_text())
...
def test_locked_solver_start_is_inside_search_bounds(monkeypatch):
    import drumfoundry.refinement.metal_search as search
