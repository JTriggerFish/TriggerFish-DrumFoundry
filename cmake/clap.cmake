...
foreach(preset kick snare hihat crash ride gong)
  set(preset_path "${PROJECT_SOURCE_DIR}/presets/factory/${preset}.fit.json")
  set_property(DIRECTORY APPEND PROPERTY CMAKE_CONFIGURE_DEPENDS "${preset_path}")
  file(READ "${preset_path}" preset_json)
  string(JSON reference_type TYPE "${preset_json}" reference)
  if(NOT reference_type STREQUAL "NULL")
    message(FATAL_ERROR "Factory presets must not include reference samples: ${preset_path}")
  endif()
