...
function Build-Native([bool]$WithClap = $false, [bool]$WithStandalone = $false) {
    ...
    Invoke-Checked cmake ($arguments + @("-DDRUMFOUNDRY_BUILD_CLAP=$clapOption", "-DDRUMFOUNDRY_BUILD_STANDALONE=$standaloneOption"))
