...
struct CrashCymbalFitParameters {
  std::array<float, CrashModalAnchorCapacity> sparseFrequencyHz{
      ...
      15000.f, 15000.f, 15000.f, 15000.f};
  std::array<float, CrashModalAnchorCapacity> sparseAmplitude{
      .35f, .15f, .15f, .55f, .25f, .7f,
      .65f, .7f, .55f, .5f, .4f, .25f,
      .32f, .38f, .44f, .5f, .56f, .6f,
      .62f, .6f, .54f, .46f, .35f, .22f,
      0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f};
  std::array<float, CrashModalAnchorCapacity> fieldTurbulenceScale{
  ...
  float bodyExcitationCentreHz{1000.f};
